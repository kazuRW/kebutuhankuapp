...
<html lang="en-US" dir="ltr">
  ...
  <head>
    ...
    <meta name="msapplication-TileImage" content="public=.public/assets/img/favicons/mstile-150x150.png">
  ...
  <body>
    ...
    <main class="main" id="top">
      <nav class="navbar navbar-expand-lg navbar-light sticky-top" data-navbar-on-scroll="data-navbar-on-scroll">
        <div class="container"><a class="navbar-brand" href="home"><img src="public/assets/img/logo.svg" height="31" alt="logo" /></a>
          ...
          <div class="collapse navbar-collapse border-top border-lg-0 mt-4 mt-lg-0" id="navbarSupportedContent">
            <ul class="navbar-nav ms-auto">
              ...
              <li class="nav-item"><a class="nav-link" aria-current="page" href="#">Tentang Kami</a></li>
              <li class="nav-item"><a class="nav-link" aria-current="page" href="#">Penawaran</a></li>
              <li class="nav-item"><a class="nav-link" aria-current="page" href="#">Kontak</a></li>
            </ul>
            <div class="d-flex ms-lg-4"><a class="btn btn-secondary-outline" href="#!">Masuk</a><a class="btn btn-warning ms-3" href="#!">Daftar</a></div>
          </div>
        </div>
      </nav>
      <section class="pt-7">
        <div class="container">
          <div class="row align-items-center">
            <div class="col-md-6 text-md-start text-center py-6">
              <h1 class="mb-4 fs-9 fw-bold">Segala Kebutuhanku dalam satu aplikasi</h1>
              <p class="mb-6 lead text-secondary">Kebutuhan Tutorial, desain dengan professional, dan lain lain<br class="d-none d-xl-block" />in one place! The most intuitive way to imagine<br class="d-none d-xl-block" />your next user experience.</p>
              <div class="text-center text-md-start"><a class="btn btn-warning me-3 btn-lg" href="#!" role="button">Mulai Sekarang</a><a class="btn btn-link text-warning fw-medium" href="#!" role="button" data-bs-toggle="modal" data-bs-target="#popupVideo"><span class="fas fa-play me-2"></span>Watch the video </a></div>
            </div>
            <div class="col-md-6 text-end"><img class="pt-7 pt-md-0 img-fluid" src="public/assets/img/hero/hero-img.png" alt="" /></div>
          </div>
        </div>
      </section>
      ...
      <section class="pt-5 pt-md-9 mb-6" id="feature">
        ...
        <div class="bg-holder z-index--1 bottom-0 d-none d-lg-block" style="background-image:url(public/assets/img/category/shape.png);opacity:.5;">
        </div>
        <!--/.bg-holder-->

        <div class="container">
          <h1 class="fs-9 fw-bold mb-4 text-center"> Kita mendesain dengan sangat baik <br class="d-none d-xl-block" />dengan hal kebutuhan yang di perlukan</h1>
          <div class="row">
            <div class="col-lg-3 col-sm-6 mb-2"> <img class="mb-3 ms-n3" src="public/assets/img/category/icon1.png" width="75" alt="Feature" />
              <h4 class="mb-3">Pertama klik tes</h4>
              <p class="mb-0 fw-medium text-secondary">While most people enjoy casino gambling,</p>
            </div>
            <div class="col-lg-3 col-sm-6 mb-2"> <img class="mb-3 ms-n3" src="public/assets/img/category/icon2.png" width="75" alt="Feature" />
            ...
            <div class="col-lg-3 col-sm-6 mb-2"> <img class="mb-3 ms-n3" src="public/assets/img/category/icon3.png" width="75" alt="Feature" />
              <h4 class="mb-3">Preference tests</h4>
              <p class="mb-0 fw-medium text-secondary">The Myspace page defines the individual.</p>
            </div>
            <div class="col-lg-3 col-sm-6 mb-2"> <img class="mb-3 ms-n3" src="public/assets/img/category/icon4.png" width="75" alt="Feature" />
      ...
      <section class="pt-5" id="validation">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-6"><img class="img-fluid" src="public/assets/img/validation/validation.png" alt="" /></div>
          </div>
        </div><!-- end of .container-->
      ...
      <section class="pt-5" id="manager">
        ...
        <div class="container">
          <div class="row">
            <div class="col-lg-6"><img class="img-fluid" src="public/assets/img/manager/manager.png" alt="" /></div>
            <div class="col-lg-6">
              ...
              <div class="d-flex align-items-center mb-3"> <img class="me-sm-4 me-2" src="public/assets/img/manager/tick.png" width="35" alt="tick" />
      ...
      <section class="pt-5" id="marketer">
        ...
        <div class="container">
          <div class="row">
            ...
            <div class="col-lg-6"><img class="img-fluid" src="public/assets/img/marketer/marketer.png" alt="" /></div>
          </div>
        </div><!-- end of .container-->
      ...
      <section class="py-md-11 py-8" id="superhero">
        ...
        <div class="bg-holder z-index--1 bottom-0 d-none d-lg-block background-position-top" style="background-image:url(public/assets/img/superhero/oval.png);opacity:.5; background-position: top !important ;">
        </div>
        <!--/.bg-holder-->
        ...
        <div class="container">
          ...
          <div class="row">
            <div class="col-md-4 mb-4">
              <div class="card"><img class="card-img-top" src="public/assets/img/marketing/marketing01.png" alt="" />
            ...
            <div class="col-md-4 mb-4">
              <div class="card"><img class="card-img-top" src="public/assets/img/marketing/marketing02.png" alt="" />
                <div class="card-body ps-0">
                  <p class="text-secondary">By <a class="fw-bold text-decoration-none me-1" href="#">Abdullah</a>|<span class="ms-1">03 March 2019</span></p>
            ...
            <div class="col-md-4 mb-4">
              <div class="card"><img class="card-img-top" src="public/assets/img/marketing/marketing03.png" alt="" />
                <div class="card-body ps-0">
                  <p class="text-secondary">By <a class="fw-bold text-decoration-none me-1" href="#">Abdullah</a>|<span class="ms-1">03 March 2019</span></p>
      ...
      <section class="pb-2 pb-lg-5">
        ...
        <div class="container">
          <div class="row border-top border-top-secondary pt-7">
            <div class="col-lg-3 col-md-6 mb-4 mb-md-6 mb-lg-0 mb-sm-2 order-1 order-md-1 order-lg-1"><img class="mb-4" src="public/assets/img/logo.svg" width="184" alt="" /></div>
